...
<head>
    ...
    <link rel="stylesheet" href="core2/html/material/css/styles.css?_=4" type="text/css"/>
	...
	<script type="text/javascript" language="javascript" src="core2/html/material/js/main.js?_=3"></script>
    <!--[if IE]>
