...
<head>
    ...
    <script type="text/javascript" src="core2/html/material/js/coreui.table.js?_=11"></script>
    ...
    <script type="text/javascript" src="core2/html/material/js/class.edit.js?_=14"></script>
