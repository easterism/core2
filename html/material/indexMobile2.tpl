...
<head>
    ...
    <link rel="stylesheet" href="core2/html/material/css/menu.css?_=2" type="text/css"/>
    <link rel="stylesheet" href="core2/html/material/css/styles.css?_=2" type="text/css"/>
	...
	<script type="text/javascript" language="javascript" src="core2/html/material/js/main.js?_=2"></script>
    <!--[if IE]>
