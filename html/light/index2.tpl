...
<head>
    ...
    <link rel="stylesheet" href="core2/html/light/css/styles.css?_=24" type="text/css"/>
	...
	<script type="text/javascript" src="core2/html/light/js/coreui.table.js?_=6"></script>
