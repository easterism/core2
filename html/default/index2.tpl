...
<head>
	...
	<link href="core2/html/default/jquery/ui-lightness/jquery-ui-1.10.3.custom.min.css" type="text/css" rel="stylesheet" />
	...
	<script type="text/javascript" language="javascript" src="core2/js/jquery/plugins/jquery.simplemodal-1.4.4.min.js"></script>
	...
	<script type="text/javascript" language="javascript" src="core2/js/jquery/jquery.iframe-transport.js"></script>
	<script type="text/javascript" language="javascript" src="core2/js/jquery/jquery.fileupload.js"></script>
	<script type="text/javascript" language="javascript" src="core2/js/jquery/jquery.fileupload-process.js"></script>
	<script type="text/javascript" language="javascript" src="core2/js/jquery/jquery.fileupload-validate.js"></script>
	<script type="text/javascript" language="javascript" src="core2/js/jquery/jquery.fileupload-ui.js"></script>
	<!--[if (gte IE 8)&(lt IE 10)]>
	<script src="core2/js/jquery/cors/jquery.xdr-transport.js"></script>
	<![endif]-->
