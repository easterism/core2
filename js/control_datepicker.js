...
if (typeof control_datepicker === 'undefined') {
    ...
    var control_datepicker = {
        ...
        callbackChange: function (date, date2, wrapper) {
            if (typeof control_datepicker.callback_change === 'function') {
                control_datepicker.callback_change(date, date2, wrapper);
            }
        },
        ...
        setCallbackChange: function (func) {
            if (typeof func === 'function') {
                control_datepicker.callback_change = func;
            }
        },
