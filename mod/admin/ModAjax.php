...
class ModAjax extends ajaxFunc {
     ...
     * @throws Exception
     */
    public function saveModule(array $data): xajaxResponse {
        ...
        if (isset($data['control']['dependencies']) && $data['control']['dependencies']) {
            ...
            foreach ($data['control']['dependencies'] as $moduleId) {
                $res[] = [ 'module_id' => $moduleId, 'm_name' => $data['dep_' . $moduleId] ];
            }
            $data['control']['dependencies'] = base64_encode(serialize($res));
        }
        $data['access']                    = ! empty($data['access']) ? $data['access'] : [];
...
//			$this->response->script("$('#module_{$module_id} span span').text('{$data['control']['m_name']}');");
     ...
     * @throws Exception
     */
	public function saveModuleSub(array $data): xajaxResponse {
     ...
     * @throws Exception
     */
    public function saveEnum(array $data): xajaxResponse {
     ...
     * @return xajaxResponse
     */
    public function saveEnumValue(array $data): xajaxResponse {
        ...
        try {
            ...
            if ($data['control']['is_default_sw'] == 'Y') {
                ...
                $this->db->update('core_enum', [ 'is_default_sw' => 'N' ], $where);
            }
     ...
     * @return xajaxResponse
     */
	public function saveSettings(array $data): xajaxResponse {
     ...
     * @throws Exception
     */
    public function saveCustomSettings(array $data): xajaxResponse {
     ...
     * @throws Exception
     */
	public function savePersonalSettings(array $data): xajaxResponse {
     ...
     */
    public function saveAvailModule(array $data): xajaxResponse {
        ...
        try {
            ...
            if ($file_type == "application/zip") {
                ...
                $SQL  = "SELECT id
                          ...
                          WHERE module_id = ?
                            AND version = ?";
                $vars = [ $xmlObj->install->module_id, $xmlObj->install->version ];
