...
class Billing extends Common {
    ...
    public function getBalance() {
        ...
        if ($this->issetModuleControl()) {
            ...
            return $balance = $this->db->fetchOne("
                SELECT SUM(price)
    ...
    protected function notifySuccessComing($operation_num) {
        ...
        $this->module = 'billing';
        if ( ! empty($this->moduleConfig->mail_success_coming) && ! empty($this->moduleConfig->mail_success_coming)) {
            ...
            if ( ! empty($operation)) {
                $mail_to      = $this->moduleConfig->mail_success_coming;
                ...
                if ( ! empty($this->moduleConfig->mail_from)) {
                    $mail->from($this->moduleConfig->mail_from);
                }
